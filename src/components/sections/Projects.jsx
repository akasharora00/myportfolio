...
export default function Projects() {
  ...
  return (
    <div className="flex h-full w-full font-vscode">
      {/* Line Numbers */}
      <div className="hidden sm:flex flex-col text-right pr-4 pl-3 select-none text-vscode-textSecondary text-[11px] leading-6 border-r border-vscode-border/30 w-12 font-mono opacity-40 shrink-0">
        {lines.map((line) => (
      ...
      {/* Main Content */}
      <div className="flex-1 w-full overflow-y-auto px-6 py-5">
        {/* Header */}
